//
//  InstagramV2CollectionViewCell.swift
//  
//
...
class InstagramV2CollectionViewCell: UICollectionViewCell {
    
    static var height: Int {
        let getHeight = UIScreen.main.bounds.width * 2.1
...
extension InstagramV2CollectionViewCell {
